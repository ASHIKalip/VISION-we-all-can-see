...
public class Weather extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cityInput = findViewById(R.id.city_txt_input);
        voice_btn = findViewById(R.id.weather_img);
        ...
        voice_btn.setOnClickListener(view -> voice_to_text());
    }
        ...
        switch (requestCode) {
            case VOICE_CODE: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if (cityInput.getText().toString().equals("read")) {
                    ...
                    } else if (cityInput.getText().toString().equals("main menu")) {
                        Intent intent = new Intent(getApplicationContext(), Home.class);
                        startActivity(intent);
                    } else if (cityInput.getText().toString().equals("location")) {
                        Intent intent = new Intent(getApplicationContext(), LocationActivity.class);
                        startActivity(intent);
                        cityInput.setText(null);
                    } else if (cityInput.getText().toString().equals("battery")) {
                        Intent intent = new Intent(getApplicationContext(), Battery.class);
                        startActivity(intent);
                        cityInput.setText(null);
                    } else if (cityInput.getText().toString().contains("bank transfer")) {
                        Intent i = new Intent(Weather.this, Banktransfer.class);
                        startActivity(i);
                    } else if (cityInput.getText().toString().contains("phone transfer")) {
                        Intent i = new Intent(Weather.this, phonetransfer.class);
                        startActivity(i);
                        ...
                        startActivity(intent);
                    } else if (cityInput.getText().toString().contains("scan the QR") || cityInput.getText().toString().contains("QR code")) {
                        Intent i = new Intent(Weather.this, QRactivity.class);
                        startActivity(i);
                    } else if (cityInput.getText().toString().contains("object detection")) {
                        Intent i = new Intent(Weather.this, ObjectDetection.class);
                        startActivity(i);
                    } else if (cityInput.getText().toString().contains("message")) {
                        Intent i = new Intent(this, MessageReader.class);
                        startActivity(i);
                    } else if (cityInput.getText().toString().contains("music")) {
    ...
    public void onDestroy() {
        if (cityInput.getText().toString().contains("exit")) {
            System.exit(0);
            super.onDestroy();
        }
    }
