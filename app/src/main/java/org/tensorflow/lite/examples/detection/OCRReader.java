...
public class OCRReader extends AppCompatActivity {
    ...
    private void textRecognizer() {
        ...
        handler.postDelayed(() -> textToSpeech.speak("Image is clearly visible tap on the screen", TextToSpeech.QUEUE_FLUSH, null),5000);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQ_CODE_SPEECH_INPUT) {
            ...
            if (mVoiceInputTv.getText().toString().contains("bank transfer")) {
                Intent i = new Intent(OCRReader.this, Banktransfer.class);
                startActivity(i);
            } else if (mVoiceInputTv.getText().toString().contains("phone transfer")) {
                Intent i = new Intent(OCRReader.this, phonetransfer.class);
                startActivity(i);
            } else {
            ...
            if (mVoiceInputTv.getText().toString().contains("object detection")) {
                Intent i = new Intent(OCRReader.this, ObjectDetection.class);
                startActivity(i);
            }
           else if (mVoiceInputTv.getText().toString().contains("main menu")) {
                Intent i = new Intent(OCRReader.this, Home.class);
                startActivity(i);
            }
            if (mVoiceInputTv.getText().toString().contains("scan the QR") || mVoiceInputTv.getText().toString().contains("QR")) {
                Intent i = new Intent(OCRReader.this, QRactivity.class);
                startActivity(i);
            }
