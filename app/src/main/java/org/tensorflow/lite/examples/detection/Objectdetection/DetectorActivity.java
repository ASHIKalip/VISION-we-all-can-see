...
import org.tensorflow.lite.examples.detection.Objectdetection.tracking.MultiBoxTracker;
import org.tensorflow.lite.examples.detection.R;
import org.tensorflow.lite.examples.detection.Objectdetection.env.BorderedText;
...
public class DetectorActivity extends CameraActivity {
                        ...
                        try (BufferedReader reader = new BufferedReader(
                            ...
                            while ((mLine = reader.readLine()) != null) {
                                if (result.toString().contains(mLine)) {
                                    texttospeech.speak("detected Object is " + mLine, TextToSpeech.QUEUE_FLUSH, null);
                                }
                            }
    ...
    public boolean onKeyDown(int keyCode, @Nullable KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_VOLUME_UP) {
            ...
            finish();
            Intent intent = new Intent(DetectorActivity.this, Home.class);
