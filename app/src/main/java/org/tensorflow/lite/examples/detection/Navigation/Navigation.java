...
public class Navigation extends AppCompatActivity {
    ...
    private Navigation.LocationAddressResultReceiver addressResultReceiver;//receives the address results
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addressResultReceiver = new Navigation.LocationAddressResultReceiver(new Handler());
