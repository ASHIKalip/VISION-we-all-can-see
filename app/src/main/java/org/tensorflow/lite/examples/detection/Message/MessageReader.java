...
public class MessageReader extends AppCompatActivity implements TextToSpeech.OnUtteranceCompletedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textTospeech = new TextToSpeech(MessageReader.this, status -> {
...
//startActivity(new Intent(this, Home.class));
    ...
    public void Messages() {
        if (readmessage == null) readmessage = "read message";
        if (readmessage.equals("read message")) {
