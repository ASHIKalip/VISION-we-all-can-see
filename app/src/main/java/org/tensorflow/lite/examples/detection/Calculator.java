        ...
        switch (requestCode) {
            case REQ_CODE_SPEECH_INPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if (txtInput.getText().toString().contains("scan the QR") || txtInput.getText().toString().contains("QR code")) {
                        Intent i = new Intent(Calculator.this, QRactivity.class);
                        startActivity(i);
                    }
                    if (txtInput.getText().toString().contains("weather")) {
                    ...
                    if (txtInput.getText().toString().contains("bank transfer")) {
                        Intent i = new Intent(Calculator.this, Banktransfer.class);
                        startActivity(i);
                    } else if (txtInput.getText().toString().contains("phone transfer")) {
                        Intent i = new Intent(Calculator.this, phonetransfer.class);
                        startActivity(i);
                    } else {
                    ...
                    if (txtInput.getText().toString().contains("object detection")) {
                        Intent i = new Intent(Calculator.this, ObjectDetection.class);
                        startActivity(i);
                    }
                    if (txtInput.getText().toString().contains("time and date")) {
                        Intent intent = new Intent(getApplicationContext(), DateAndTime.class);
                        startActivity(intent);
                    }
                    if (txtInput.getText().toString().contains("location")) {
                        Intent intent = new Intent(getApplicationContext(), LocationActivity.class);
                        startActivity(intent);
                        txtInput.setText(null);
                    }
                    else if (txtInput.getText().toString().contains("message")) {
                        Intent i = new Intent(this, MessageReader.class);
                        startActivity(i);
                    } else if (txtInput.getText().toString().contains("music")) {
                        Intent i = new Intent(this, Music.class);
                        startActivity(i);
                    }
                    if (txtInput.getText().toString().contains("battery")) {
